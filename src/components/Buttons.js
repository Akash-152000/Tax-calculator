...
class Buttons extends Component {
    ...
    render() {
        return (
            <div>
                <button className="button" onClick={() =>{this.props.handleClick(this.props.money)}}>
                    ...
                    <svg className="button__svg" role="presentational" viewBox="0 0 600 600">
                        ...
                        <g id="money">
                            ...
                            <path d="M424.73,165.49c-10-2.53-17.38-12-17.68-24H316.44c-.09,11.58-7,21.53-16.62,23.94-3.24.92-5.54,4.29-5.62,8.21V376.54H430.1V173.71C430.15,169.83,427.93,166.43,424.73,165.49Z" fill="#699e64" stroke="#323c44" strokeMiterLimit="10" stroke-width="14" />
                        </g>
                        <g id="creditcard">
